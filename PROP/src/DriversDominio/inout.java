package DriversDominio;/* Aquesta es una adaptacio d'un conjunt de classes
...
public class inout {
    ...
    private static inout instace; //singeltone
  ...
  public void writeln (double[][] m) throws Exception {
    ...
    public void write(Set<String> s) throws Exception {
        for (String s1 : s) {
            writeln(s1);
        }
    ...
    public void write(String[] opciones) throws Exception {
      int i = 0;
        for (String s1 : opciones) {
            write(i + " ");
            writeln(s1) ;
            i++;
        }
